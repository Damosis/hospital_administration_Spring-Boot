...
@RestController
@RequestMapping(path = "/hospital/consultation")
public class ConsultationController {
	...
	@GetMapping(path = "/")
	public ResponseEntity<Collection<Consultation>> getConsultations(){
		try {
			Collection<Consultation> consultations = consultationService.getConsultations();
